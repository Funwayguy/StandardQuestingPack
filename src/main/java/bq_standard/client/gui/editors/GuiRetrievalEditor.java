...
public class GuiRetrievalEditor extends GuiQuesting implements IVolatileScreen
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiButtonQuesting(2, guiLeft + sizeX/2 - 100, guiTop + sizeY/2 + 00, 200, 20, I18n.format("bq_standard.btn.consume", JsonHelper.GetBoolean(data, "consume", true))));
		this.buttonList.add(new GuiButtonQuesting(3, guiLeft + sizeX/2 - 100, guiTop + sizeY/2 + 20, 200, 20, I18n.format("betterquesting.btn.advanced")));
	}
