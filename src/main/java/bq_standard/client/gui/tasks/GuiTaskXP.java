...
public class GuiTaskXP extends GuiElement implements IGuiEmbedded
{
	...
	public void drawBackground(int mx, int my, float partialTick)
	{
		...
		long xp = quest == null || !quest.getProperties().getProperty(NativeProps.GLOBAL)? task.getPartyProgress(QuestingAPI.getQuestingUUID(mc.thePlayer)) : task.getGlobalProgress();
