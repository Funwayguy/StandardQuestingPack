    ...
    public void initPanel()
    {
        ...
        IGuiTexture texCompass = new IGuiTexture()
        {
            ...
            public void drawTexture(int x, int y, int width, int height, float zDepth, float partialTick, IGuiColor color)
            {
                ...
                RenderUtils.DrawLine(cx + radius, cy + radius, cx + radius, cy - radius, 4, Color.WHITE.getRGB());
                RenderUtils.DrawLine(cx + radius, cy + radius, cx - radius, cy + radius, 4, Color.WHITE.getRGB());
                mc.fontRendererObj.drawString(TextFormatting.BOLD + "N", cx - 4, cy - radius - 9, txtClr);
                mc.fontRendererObj.drawString(TextFormatting.BOLD + "S", cx - 4, cy + radius + 2, txtClr);
                mc.fontRendererObj.drawString(TextFormatting.BOLD + "E", cx + radius + 2, cy - 4, txtClr);
                mc.fontRendererObj.drawString(TextFormatting.BOLD + "W", cx - radius - 8, cy - 4, txtClr);
