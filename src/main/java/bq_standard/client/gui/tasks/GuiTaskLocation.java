	...
	public void drawBackground(int mx, int my, float partialTick)
	{
		...
		if(!task.hideInfo)
		{
			if(task.range >= 0)
			{
				...
				i += 12;
				mc.fontRenderer.drawString(I18n.format("bq_standard.gui.distance", (int)mc.thePlayer.getDistance(task.x, task.y, task.z) + "m"), posX, posY + i, getTextColor(), false);
				i += 12;
			}
		...
		{
			mc.fontRenderer.drawString(EnumChatFormatting.BOLD + I18n.format("bq_standard.gui.undiscovered"), posX, posY + i, Color.RED.getRGB(), true);
		}
		...
		RenderUtils.DrawLine(cx + radius, cy + radius, cx + radius, cy - radius, 4, Color.WHITE.getRGB());
		RenderUtils.DrawLine(cx + radius, cy + radius, cx - radius, cy + radius, 4, Color.WHITE.getRGB());
		mc.fontRenderer.drawString(EnumChatFormatting.BOLD + "N", cx - 4, cy - radius - 9, getTextColor());
		mc.fontRenderer.drawString(EnumChatFormatting.BOLD + "S", cx - 4, cy + radius + 2, getTextColor());
		mc.fontRenderer.drawString(EnumChatFormatting.BOLD + "E", cx + radius + 2, cy - 4, getTextColor());
		mc.fontRenderer.drawString(EnumChatFormatting.BOLD + "W", cx - radius - 8, cy - 4, getTextColor());
