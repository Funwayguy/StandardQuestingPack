...
public class GuiTaskRetrieval extends GuiEmbedded
{
	...
	public void drawGui(int mx, int my, float partialTick)
	{
		...
		screen.mc.fontRendererObj.drawString(StatCollector.translateToLocalFormatted("bq_standard.btn.consume", sCon), posX, posY, ThemeRegistry.curTheme().textColor().getRGB(), false);
