...
public class GuiHQMBagImporter extends GuiEmbedded
{
	...
	{
		RenderUtils.drawSplitString(this.screen.mc.fontRendererObj, I18n.translateToLocal("bq_standard.importer.hqm_bag.desc"), this.posX + 8, this.posY, this.sizeX - 16, ThemeRegistry.curTheme().textColor().getRGB(), false);
