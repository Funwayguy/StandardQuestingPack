...
public class GuiHQMQuestImporter extends GuiElement implements IGuiEmbedded
{
	...
	public GuiHQMQuestImporter(int posX, int posY, int sizeX, int sizeY)
	{
	...
	{
		RenderUtils.drawSplitString(mc.fontRenderer, I18n.format("bq_standard.importer.hqm_quest.desc"), this.posX + 8, this.posY, this.sizeX - 16, getTextColor(), false);
