...
public class PlayerContainerListener implements IContainerListener
{
    ...
    @Override
    public void updateCraftingInventory(@Nonnull Container container, @Nonnull List<ItemStack> nonNullList)
    {
        updateTasks();
    }
    ...
    @Override
    public void sendProgressBarUpdate(@Nonnull Container container, int i, int i1){}
